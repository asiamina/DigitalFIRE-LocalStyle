Note:
## This version of DigitalFIRE offers a local/Drupal style format of this educational tool. There are also the following two formats that you can use. They are all synchronized and identidal:

1. DigitalFIRE - Web Style/Format: https://asiamina.github.io/DigitalFIRE-WebStyle/

2. DigitalFIRE - Wiki Style/Format: https://asiamina.github.io/DigitalFIRE-WikiStyle/ 
